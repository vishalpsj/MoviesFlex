        ...
        <>
            <div className="selectedPage ">
                ...
                <div className="data flex flex-col gap-6">
                    ...
                    <p className="flex gap-2 items-center text-2xl"><span className="text-4xl text-blue-500"><FaLanguage /></span><b>Available Languages: </b>{loaderdata.spoken_languages.map((langs) => langs.name).join(", ")}</p>
